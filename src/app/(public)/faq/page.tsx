  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: '결제 완료 후 등록된 이메일로 영수증이 자동 발송됩니다. 세금계산서가 필요하신 경우 support@voxcierge.com으로 사업자 정보를 보내주시면 발행해 드립니다.',
      },
      {
        q: '결제는 얼마나 안전한가요?',
        a: '결제는 글로벌 결제 전문 기업 Stripe를 통해 처리되며, PCI DSS Level 1 인증을 받은 안전한 시스템입니다. 카드 정보는 VoxCierge 서버에 저장되지 않습니다.',
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        a: '비밀번호 재설정 기능을 이용해 주세요. 이메일로 재설정 링크가 발송됩니다. 그래도 해결이 안 되면 support@voxcierge.com으로 문의해 주세요.',
      },
      {
      ...
      },
      {
        ...
        a: '브라우저 캐시를 지우고 페이지를 새로고침해 보세요. 그래도 느리다면 다른 브라우저로 시도해 보시거나, support@voxcierge.com으로 문의해 주세요.',
      },
      {
        q: '알림이 오지 않아요.',
